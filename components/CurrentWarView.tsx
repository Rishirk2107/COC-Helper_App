    ...
    return (
      <div className="space-y-6">
        <div className="bg-gray-800 rounded-xl p-8 text-center border border-gray-700">
          ...
          <p className="text-gray-400">{war.message || 'Your clan is not currently participating in a war.'}</p>
        </div>

        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <p className="text-xl font-bold text-white">{war.clan?.name || 'Your Clan'}</p>
            ...
            <div>
              <p className="text-xl font-bold text-white">{war.opponent?.name || 'Opponent'}</p>
